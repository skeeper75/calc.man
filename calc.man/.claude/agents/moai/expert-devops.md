...
skills: moai-foundation-claude, moai-foundation-core, moai-foundation-philosopher, moai-workflow-project, moai-workflow-jit-docs, moai-workflow-templates, moai-platform-deployment, moai-platform-database-cloud, moai-framework-electron
hooks:
  PostToolUse:
    - matcher: "Write|Edit"
      hooks:
